...
Verifies that the committed docs/tech-spec-v*.pdf carries a valid digital
signature from a trusted signer before an AI agent references it as authoritative.
...
Usage:
    python scripts/verify_spec_signature.py docs/tech-spec-v*.pdf
