...
| Field | Value |
|---|---|
| **Spec section** | §4.B.2 — Physiological Ingestion Adapter; §4.C.4 — Physiological State Buffer; §6.2 — Physiological Chunk Event; §6.3 — Physiological Context; §7C — Co-Modulation Analytics; §11.3 — Variable Matrix |
