...
Steps:
1. TRUST GATE: Run `python scripts/verify_spec_signature.py docs/tech-spec-v3.2.pdf`. If FAIL, STOP and report. Do not implement anything against an unverified spec.
