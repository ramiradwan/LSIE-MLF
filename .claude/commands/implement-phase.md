...
Steps:
1. TRUST GATE: Resolve the single `docs/tech-spec-v*.pdf` match and run `python scripts/verify_spec_signature.py <resolved-pdf>`. If FAIL, STOP and report. Do not implement anything against an unverified spec.
