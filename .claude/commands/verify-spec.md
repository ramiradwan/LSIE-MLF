Before referencing docs/tech-spec-v3.2.pdf as authoritative, verify its digital signature.

Steps:
1. Run `python scripts/verify_spec_signature.py docs/tech-spec-v3.2.pdf`
