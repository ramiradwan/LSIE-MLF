...
6. api (depends: redis + worker + postgres; redis is required for Oura notification ingress plus the in-process hydration worker that emits PhysiologicalChunkEvent records on `physio:events`)
